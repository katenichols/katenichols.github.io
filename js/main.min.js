...
/* harmony import */ var _modules_anchors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/anchors */ "./js/modules/anchors.js");
/* harmony import */ var _modules_header_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header-modal */ "./js/modules/header-modal.js");
/* harmony import */ var _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/nav-btn */ "./js/modules/nav-btn.js");
...
/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/map */ "./js/modules/map.js");
/* harmony import */ var _modules_map__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_map__WEBPACK_IMPORTED_MODULE_6__);
...
var pageHeaderPictureNoJs = document.querySelector('[data-header-picture-nojs]');
var containerNoJs = document.querySelector('[data-container-nojs]');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["pageHeader"].classList.remove('page-header--no-js');
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["pageHeaderPicture"].style.display = 'inline-block';
  pageHeaderPictureNoJs.style.display = 'none';
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["pageHeaderWrapper"].classList.remove('page-header__wrapper--no-js');
  containerNoJs.classList.remove('container--no-js');
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["nav"].classList.remove('nav--no-js');
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["navBtn"].classList.remove('nav__btn--no-js');
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_4__["navList"].classList.remove('nav__list--no-js'); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _header_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header-modal */ "./js/modules/header-modal.js");
...
var _iterator = _createForOfIteratorHelper(_header_modal__WEBPACK_IMPORTED_MODULE_0__["navLinks"]),
    _step;
...
/* harmony import */ var _utils_esc_key__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../utils/esc-key */ "./js/utils/esc-key.js");
/* harmony import */ var _modules_nav_btn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/nav-btn */ "./js/modules/nav-btn.js");




var closeModal = function closeModal() {
  Object(_modules_nav_btn__WEBPACK_IMPORTED_MODULE_2__["classListsToggle"])();
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_2__["body"].style.position = 'relative';
  _modules_nav_btn__WEBPACK_IMPORTED_MODULE_2__["body"].style.top = 'auto';
  _main__WEBPACK_IMPORTED_MODULE_0__["lastFocus"].focus();
  document.removeEventListener('keydown', _utils_esc_key__WEBPACK_IMPORTED_MODULE_1__["onEscKeydown"]);
};
...
var inputName = form.querySelector('[data-name]');
var inputPhone = form.querySelector('[data-phone]');
var inputEmail = form.querySelector('[data-email');
var inputCheckbox = form.querySelector('[data-assent]');
var labelCheckbox = form.querySelector('[data-label-checkbox]');
var formData = {
  name: '',
  phone: '',
  email: '',
...
var data = localStorage.getItem('items') ? JSON.parse(localStorage.getItem('items')) : formData;
...
var isEmail = function isEmail() {
  var regMail = /^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i;
  return regMail.test(inputEmail.value);
};

var isAssent = function isAssent() {
...
var addClasslist = function addClasslist(elem) {
...
/* harmony import */ var _close_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./close-modal */ "./js/modules/close-modal.js");
/* harmony import */ var _nav_btn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nav-btn */ "./js/modules/nav-btn.js");

 // import {anchors} from './anchors';


var navLinks = _nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeader"].querySelectorAll('[data-nav-link]');
var focusables = _nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeader"].querySelectorAll('[data-nav-link], [data-nav-btn');
var firstFocusable = focusables[0];
var lastFocusable = focusables[focusables.length - 1];

var onNavLinkClick = function onNavLinkClick() {
  if (_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeader"].classList.contains('page-header--modal')) {
    Object(_close_modal__WEBPACK_IMPORTED_MODULE_0__["closeModal"])();
  }
};
...
document.addEventListener('click', function (evt) {
  if (_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeaderOverlay"].classList.contains('page-header__overlay--modal')) {
    if (evt.target !== _nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeaderWrapper"] && !_nav_btn__WEBPACK_IMPORTED_MODULE_1__["pageHeaderWrapper"].contains(evt.target) && evt.target !== '[data-nav-link]') {
      Object(_close_modal__WEBPACK_IMPORTED_MODULE_0__["closeModal"])();
    }
  }
});
...
function init() {
  ...
  var myPlacemark = new ymaps.Placemark([59.937629, 30.322718], null, {
...
/***/ "./js/modules/nav-btn.js":
/*!*******************************!*\
  !*** ./js/modules/nav-btn.js ***!
  \*******************************/
/*! exports provided: body, navBtn, pageHeader, pageHeaderOverlay, pageHeaderWrapper, pageHeaderPicture, pageHeaderPictureModal, nav, navList, classListsToggle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageHeaderPicture", function() { return pageHeaderPicture; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageHeaderPictureModal", function() { return pageHeaderPictureModal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nav", function() { return nav; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "navList", function() { return navList; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "classListsToggle", function() { return classListsToggle; });
/* harmony import */ var _utils_esc_key__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../utils/esc-key */ "./js/utils/esc-key.js");
/* harmony import */ var _close_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./close-modal */ "./js/modules/close-modal.js");
...
var pageHeaderOverlay = pageHeader.querySelector('[data-header-overlay]');
var pageHeaderWrapper = pageHeader.querySelector('[data-header-wrapper]');
var pageHeaderPicture = pageHeader.querySelector('[data-header-picture]');
var pageHeaderPictureModal = pageHeader.querySelector('[data-header-picture-modal');
var nav = pageHeader.querySelector('[data-nav]');
var navList = pageHeader.querySelector('[data-nav-list-nojs]');

var onEscKeydown = function onEscKeydown(evt) {
  if (Object(_utils_esc_key__WEBPACK_IMPORTED_MODULE_0__["escKey"])(evt)) {
    Object(_close_modal__WEBPACK_IMPORTED_MODULE_1__["closeModal"])();
  }
};

var classListsToggle = function classListsToggle() {
